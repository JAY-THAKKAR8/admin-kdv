...
class DataTable2 extends DataTable {
  ...
  static const double _columnSpacing = 100.0;
  ...
  /// making it possible to have performant sticky column cells
  @override
  ...
  final Widget Function()? paginationLoadingBuilder;
            ...
            if (rows.isNotEmpty) {
              ...
              Widget addBottomMargin(Table t) => bottomMargin != null && bottomMargin! > 0
                  ? Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      if (paginationLoadingBuilder != null) paginationLoadingBuilder!(),
                    ])
                  : Column(
                      ...
                      children: [
                        ...
                        if (paginationLoadingBuilder != null)
                          Padding(padding: EdgeInsets.all(8), child: paginationLoadingBuilder!()),
                      ],
                    );
